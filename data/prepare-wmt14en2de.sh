...
# Taken from https://github.com/facebookresearch/fairseq-py/tree/master/data

echo 'Cloning Moses github repository (for tokenization scripts)...'
git clone ssh://git@github.com/moses-smt/mosesdecoder.git

echo 'Cloning Subword NMT repository (for BPE pre-processing)...'
git clone ssh://git@github.com/rsennrich/subword-nmt.git
